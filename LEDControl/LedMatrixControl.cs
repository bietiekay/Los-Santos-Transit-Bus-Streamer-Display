...
namespace LedMatrixControlNamespace
{
 ...
 /// </summary>
  ...
  public partial class LedMatrixControl : Control
  {
    ...
    System.Windows.Forms.Timer    m_tTimer;           ///<!-- Internal control timer                                      -->
    ...
    public bool LoadFontCollectionFromResource(string sResourceName)
    {
      ...
      Stream srXmlStream = File.OpenRead(sResourceName);//aAssem.GetManifestResourceStream(sResourceName);
